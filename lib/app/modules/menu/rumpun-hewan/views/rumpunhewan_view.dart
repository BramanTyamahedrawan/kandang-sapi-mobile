...
class RumpunHewanView extends GetView<RumpunHewanController> {
  const RumpunHewanView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RumpunHewanController>(
      builder: (controller) => RefreshIndicator(
        onRefresh: () async {
          await controller.loadRumpunHewan();
        },
        child: Scaffold(
          ...
          appBar: EasySearchBar(
              ...
              searchHintText: 'Cari Data Rumpun Hewan',
              ...
              onSearch: (value) => controller.searchRumpunHewan(value)),
          body: Obx(
            () {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () => {
                          Get.toNamed(
                            Routes.DETAILRUMPUNHEWAN,
                            arguments: {
                              "idRumpunHewan": "${postData.idRumpunHewan}",
                              "rumpun": "${postData.rumpun}",
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
                onPressed: () {
                  Get.toNamed(Routes.ADDRUMPUNHEWAN);
                },
