...
class JenisVaksinView extends GetView<JenisVaksinController> {
  const JenisVaksinView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<JenisVaksinController>(
      builder: (controller) => RefreshIndicator(
        onRefresh: () async {
          await controller.loadJenisVaksin();
        },
        child: Scaffold(
          ...
          appBar: EasySearchBar(
              ...
              searchHintText: 'Cari Data Jenis Vaksin',
              ...
              onSearch: (value) => controller.searchJenisVaksin(value)),
          body: Obx(
            () {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () => {
                          Get.toNamed(
                            Routes.DETAILJENISVAKSIN,
                            arguments: {
                              "idJenisVaksin": "${postData.idJenisVaksin}",
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
                onPressed: () {
                  Get.toNamed(Routes.ADDJENISVAKSIN);
                },
