...
class TujuanPemeliharaanView extends GetView<TujuanPemeliharaanController> {
  const TujuanPemeliharaanView({super.key});

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TujuanPemeliharaanController>(
      builder: (controller) => RefreshIndicator(
        onRefresh: () async {
          await controller.loadTujuanPemeliharaan();
        },
        child: Scaffold(
          ...
          appBar: EasySearchBar(
              ...
              searchHintText: 'Cari Data Tujuan Pemeliharaan',
              ...
              onSearch: (value) => controller.searchTujuanPemeliharaan(value)),
          body: Obx(
            () {
                  ...
                  return ListView.separated(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return InkWell(
                        onTap: () => {
                          Get.toNamed(
                            Routes.DETAILTUJUANPEMELIHARAAN,
                            arguments: {
                              "idTujuanPemeliharaan":
                                  "${postData.idTujuanPemeliharaan}",
                              "tujuanPemeliharaan":
                                  "${postData.tujuanPemeliharaan}",
                                ...
                                children: [
                                  Text(
                                    (postData.status == null)
                                        ? "-"
                                        : "Id: ${postData.idTujuanPemeliharaan}",
                                  ...
                                  Text(
                                    (postData.status == null)
                                        ? "-"
                                        : "Tujuan Pemeliharaan: ${postData.tujuanPemeliharaan}",
                                    style: const TextStyle(
                                        fontSize: 15,
          ...
          floatingActionButton: Padding(
            ...
            child: FloatingActionButton(
                onPressed: () {
                  Get.toNamed(Routes.ADDTUJUANPEMELIHARAAN);
                },
