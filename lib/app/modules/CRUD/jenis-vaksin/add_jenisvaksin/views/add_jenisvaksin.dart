...
import '../controllers/add_jenisvaksin_controller.dart';

class AddJenisVaksin extends GetView<AddJenisVaksinController> {
  const AddJenisVaksin({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(AddJenisVaksinController());
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 255, 255, 255),
      appBar: AppBar(
        title: const Text(
          'Tambah Data Jenis Vaksin',
          style: TextStyle(
            color: Colors.white,
          ),
        ),
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Jenis Vaksin", // Label untuk TextField
                      // hintText: "Jenis Vaksin", // Placeholder atau hint text
                      ...
                      () => ElevatedButton(
                        onPressed: () {
                          if (controller.isLoading.isFalse) {
                            controller.AddJenisVaksin(context);
                          }
                        },
