...
class DetailTujuanPemeliharaanView
    extends GetView<DetailTujuanPemeliharaanController> {
  const DetailTujuanPemeliharaanView({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  buildTextField(
                      "Id", controller.idTujuanPemeliharaanC, false, 1),
                  Obx(() {
                    return buildTextField(
                        "Tujuan Pemeliharaan",
                        controller.tujanPemeliharaanC,
                  ...
                  Obx(() {
                    return Center(
                      child: ElevatedButton(
                        onPressed: () {
                          controller.isEditing.value
                              ? controller.editTujuanPemeliharaan()
