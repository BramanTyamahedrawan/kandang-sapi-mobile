...
class AddTujuanPemeliharaan extends GetView<AddTujuanPemeliharaanController> {
  const AddTujuanPemeliharaan({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(AddTujuanPemeliharaanController());
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 255, 255, 255),
      appBar: AppBar(
        title: const Text(
          'Tambah Data Tujuan Pemeliharaan',
          style: TextStyle(
            color: Colors.white,
          ),
        ),
              ...
              child: Column(
                ...
                children: [
                  TextField(
                    ...
                    maxLines: 1,
                    controller: controller.tujuanPemeliharaanC,
                    keyboardType: TextInputType.name,
                    decoration: InputDecoration(
                      labelText: "Tujuan Pemeliharaan", // Label untuk TextField
                      ...
                      () => ElevatedButton(
                        onPressed: () {
                          if (controller.isLoading.isFalse) {
                            controller.AddTujuanPemeliharaan(context);
                          }
                        },
