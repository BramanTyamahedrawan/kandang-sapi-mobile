...
class DetailHewanView extends GetView<DetailHewanController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        //     } else {
        //       return Row(
        //         mainAxisSize: MainAxisSize.min, // Pastikan ukuran minimum
        //         children: [
        //           IconButton(
        //             onPressed: () {
                ...
                child: Column(
                    ...
                    children: [
                      buildTextField(
                          ...
                          controller.kodeEartagNasionalC,
                          TextInputType.name),
                      SizedBox(height: 20),
                      buildTextField(
                          "No Kartu Ternak",
                          controller.isEditing.value,
                          controller.noKartuTernakC,
                          TextInputType.name),
                      SizedBox(height: 20),
                      buildTextField(
                          "Id Isikhnas Ternak",
                          controller.isEditing.value,
                          controller.idIsikhnasHewanC,
                      ...
                      SizedBox(height: 20),
                      buildTextField("Tempat Lahir", controller.isEditing.value,
                          controller.tempatLahirC, TextInputType.name),
                      SizedBox(height: 20),
                      TextField(
                        style: const TextStyle(
  ...
  Widget buildTextField(String labelText, bool isEditable,
      TextEditingController controller, TextInputType keyboardType) {
    print('is editable: ${isEditable}');
    return TextField(
