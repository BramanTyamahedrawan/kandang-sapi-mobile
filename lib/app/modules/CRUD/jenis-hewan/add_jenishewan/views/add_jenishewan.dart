...
class AddJenishewan extends GetView<AddJenisHewanController> {
  const AddJenishewan({super.key});
  @override
  Widget build(BuildContext context) {
    Get.put(AddJenisHewanController());
    return Scaffold(
                ...
                children: [
                  TextField(
                    ...
                    decoration: InputDecoration(
                      labelText: "Jenis Hewan", // Label untuk TextField
                      ...
                      () => ElevatedButton(
                        onPressed: () {
                          if (controller.isLoading.isFalse) {
                            controller.AddJenisHewan(context);
                          }
                        },
